...
const TopBar = ({ notifs, name, title, profpic }) => {
  return (
    <div className="bg-red-500 h-[3rem] flex gap-[1rem] relative z-10 ml-[3.5rem]">
      <div className="flex items-center text-gray-600 bg-amber-400 text-sm font-bold h-[3rem] w-[95rem] pl-[0.5rem] ml-[3rem]">
        @ SAKSHAM-AI
      </div>
